...
This project is a portfolio case study, not production workflow software. v21 adds a concrete local approval state machine so reviewers can see how AI-generated artefacts move through Product, QA, Compliance, Support and Engineering review.
