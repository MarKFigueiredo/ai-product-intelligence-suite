...
| Claim category | Risk | v1.03 mitigation |
|---|---|---|
...
| Hiring outcomes | Portfolio quality can help conversion but cannot guarantee interviews. | v1.02 uses bounded wording: may improve interview conversion when targeted and packaged well. |
