...
v1.04 adds a quality learning layer on top of persisted usage metrics. This moves the project beyond “we collect metrics” toward “we use metrics to learn where the workflow improves or fails.”
