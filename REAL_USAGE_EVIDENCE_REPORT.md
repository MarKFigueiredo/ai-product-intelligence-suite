...
If the app has not been used yet, the report will show zero workflow runs. That is expected. The important v20 capability is that usage runs, metric snapshots, connector events, imports and exports can now be accumulated and exported over time.
